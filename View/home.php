<div class="container">
        <div id="ant-layout">
            <section class="search-quan">
                ...
                <form action="thucdon.php" method="GET">
                    <input name="search" type="text" placeholder="Tìm món hoặc thức ăn" style="width: 100%;">
                </form>
            </section>
        ...
        <section class="main">
                            ...
                            echo '
                                <div class="col">
                                    <a href="details.php?id=' . $item['product_id'] . '">
                                        <img class="thumbnail" src="images/' . $item['thumbnail'] . '" alt="">
                                        <div class="title">
                                            <p>' . $item['title'] . '</p>
                                        </div>
                                        <div class="price">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại quán <span class="green">Foody Coffee</span></h1>
                </div>
