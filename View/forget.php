    ...
    <div id="wrapper">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                $nguoigui = 'trongphuchuynh1432@gmail.com'; // Tài khoản Email
                $matkhau = 'pntanzaubtchpqnc'; // Mật khẩu Email
                $mail->SMTPSecure = 'tsl';  // encryption TLS/SSL 
                $mail->Port = 587;  // Port kết nối: khai báo 465 hoặc 587                


                // Recipients - Người nhận
                $tennguoigui = 'Huỳnh Trọng Phúc'; // Tên người gửi lấy từ form nhập
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                $to = $email; // Email cần gửi đến lấy từ form nhập
                $to_name = "Huỳnh Trọng Phúc"; // Tên người cần gửi đến
