...
require_once('Controller/checkout-form.php');
$cart = [];
                                ...
                                <table class="table table-bordered table-hover none">
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td style="text-align:center; display:flex">
                                            <img src="images/' . $item['thumbnail'] . '" alt="" style="width: 50px;margin:0 1rem 0 1rem;"> <span>' . $item['title'] . '</span>
                                        </td>
